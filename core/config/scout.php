...
return [
    ...
    */
    ...
    // UI-001: "database" engine (Scout ≥ 10) searches the model's own
    // columns — LIKE everywhere, and MySQL/MariaDB FULLTEXT automatically
    // when the index exists. Keeps cPanel dependency-free while making
    // search actually functional. Phase 4 VPS migration only needs
    // SCOUT_DRIVER=meilisearch — zero app code changes.
    ...
    */
    ...
    // Queue engine syncs through our database queue (cPanel-safe) so listing
    // saves never block on search-index writes.
    ...
    */
    ...
    // Never index rows from rolled-back financial transactions.
    'after_commit' => true,
